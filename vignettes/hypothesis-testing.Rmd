...
```{r}
titanic %>% fisher(., exposure = Crew, outcome = Survived, alternative = "greater")
```
```{r}
titanic %>% fisher(., exposure = Crew, outcome = Survived, alternative = "less")
```

```{r}
titanic %>% fisher(., exposure = Crew, outcome = Survived, alternative = "two.sided")
```

```{r}
titanic %>% fisher(., exposure = Crew, outcome = Survived, or = 2)
```
